...
def assign_locations(product_location: ProductLocation):
    ...
    try:
        ...
        if warehouse_x < product_location.x_coordinate:
             return {"message": "x_coordinate can not be bigger then warehouse size contrains"}
             ...
             return {"message": "y_coordinate can not be smaller than warehouse size contrains"}
